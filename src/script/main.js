...
function populateEducation() {
  ...
  portfolioData.education.forEach((edu, index) => {
    ...
    educationElement.className = `relative pl-8 ${
      isLast ? "" : "border-l-2 border-primary pb-8"
    }`;
    educationElement.innerHTML = `
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="text-gray-600 text-justify-custom">
                    ${edu.description}
                </p>
            </div>
        `;
...
function populateExperience() {
  ...
  portfolioData.experience.forEach((exp, index) => {
    ...
    expElement.className = `relative pl-8 ${
      isLast ? "" : "border-l-2 border-primary pb-8"
    }`;
...
function populateOrganizations() {
  ...
  portfolioData.organizations.forEach((org, index) => {
    ...
    orgElement.className = `relative pl-8 ${
      isLast ? "" : "border-l-2 border-primary pb-8"
    }`;
...
function populateProjects() {
  ...
  portfolioData.projects.forEach((project) => {
    ...
    const projectIconHtml =
      project.icon.startsWith("http") || project.icon.startsWith("Asset/")
